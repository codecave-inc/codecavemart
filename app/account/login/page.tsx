  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-24">
      ...
      <p className="text-on-surface-variant text-sm leading-relaxed mb-10">
        Log in to see your order history and saved details.
      </p>
      ...
      <form action={signInCustomer} className="space-y-6">
        <input type="hidden" name="redirectTo" value={redirectTo ?? "/account/orders"} />
        <div>
      ...
      <p className="text-xs text-on-surface-variant mt-8 text-center">
        New here?{" "}
        <Link href="/account/signup" className="text-secondary-fixed-dim hover:underline">
          Create an account
        </Link>
      </p>
    </div>
